...
2. Traduza tokens para a tecnologia do projeto (CSS variables, QSS, VCL, etc.).
3. Nao invente paleta ou espacamento fora deste modelo sem ordem explicita do usuario.
