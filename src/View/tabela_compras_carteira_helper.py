...
def criar_grid_compras_carteira(
    ...
    *,
    ...
    ctk.CTkLabel(
        card,
        text="Clique no titulo da coluna para ordenar. Duplo clique abre a edicao da compra.",
    ...
    for coluna, largura in zip(_COLUNAS, _LARGURAS, strict=True):
        ...
        tabela.heading(
            ...
            command=lambda c=coluna: _alternar_ordenacao_compras(tabela, c),
        )
...
def _alternar_ordenacao_compras(tabela: ttk.Treeview, coluna: str) -> None:
    ...
    preencher_grid_compras_carteira(tabela, linhas)
