"""Coordena o painel ETFs (API compativel com telas de acoes e FIIs)."""
from src.Model.etfs_universo import QUANTIDADE_PADRAO_ETFS
...
from src.Service.favoritos_etfs_servico import FavoritosEtfsServico
...
class ControladorEtfs:
    """Mesmos metodos das janelas de acoes, com filtro de ETFs."""

    def __init__(self) -> None:
        self._servico = MercadoEtfsServico()
        self._busca = BuscaEtfsServico()
        self._favoritos = FavoritosEtfsServico()
        ...
        self._composicao = ComposicaoEtfServico()
    ...
    def obter_painel(self, quantidade: int = QUANTIDADE_PADRAO_ETFS) -> dict:
        return {
    ...
    def obter_painel_periodo(
        ...
        if dados["total_com_dados"] == 0:
            return None, (
                f"Nenhum ETF com historico no periodo "
    ...
    def obter_cotacao(self, simbolo: str) -> tuple[object | None, str | None]:
        ...
        if not resumos:
            return None, "Cotacao indisponivel ou ticker nao e um ETF."
    ...
    def obter_composicao_etf(self, simbolo: str):
        return self._composicao.obter_composicao(simbolo)
    ...
    def comparar(
        ...
        if len(resultado["simbolos"]) < 2:
            ...
            return None, "Dados insuficientes para comparar (somente ETFs)."
